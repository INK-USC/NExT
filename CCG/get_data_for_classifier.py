...
def transform():
    ...
    with open('./CCG/exp_data_turk.pkl','rb') as f:
    ...
    PT_label.dump('./CCG/TK_label.npy')
    with open('./CCG/TK_tok_exp.json','w') as f:
        json.dump(PT_toks,f)
    ...
    with open('./CCG/explanations.json','w') as f:
        json.dump(dump_json,f)


    with open('./CCG/explanations.json','r') as f:
        data = json.load(f)
    pats = []
    exp2pat = {}
    ...
    with open('./CCG/pattern.json','w') as f:
        json.dump(pats,f)
    with open('./CCG/exp2pat.json','w') as f:
        json.dump(exp2pat,f)